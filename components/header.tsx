...
export default function Header() {
  return (
    <header className="bg-background supports-[backdrop-filter]:bg-background/75 border-b-foreground/10 sticky top-0 z-50 flex h-[4.5rem] w-full flex-row items-center border-b backdrop-blur-lg">
